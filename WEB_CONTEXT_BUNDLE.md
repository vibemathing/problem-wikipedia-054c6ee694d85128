...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-054c6ee694d85128"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-054c6ee694d85128",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-054c6ee694d85128",
        "url": "https://en.wikipedia.org/wiki/Moser%27s_worm_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Moser's worm problem – what is the smallest area of a shape that can cover every unit-length curve in the plane?",
      "version": 1
    },
    "title": "Moser's worm problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "f2175fc97070c612513a6f244486ea0842e51886808d7be38d692c3d3b6d35d1"
}
```
